...
import AudiobookListenClient from '@/components/AudiobookListenClient';
...
export default function AudiobookListenPage({ params }: Props) {
  return <AudiobookListenClient />;
}